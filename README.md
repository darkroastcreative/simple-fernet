...
Please note that this guide assumes that you have not yet generated a Fernet key and includes steps to generate this key and store it in environment variables for `simple-fernet` to use. If you have already generated a Fernet key and stored it in an environment variable, feel free to skip ahead in the guide.
